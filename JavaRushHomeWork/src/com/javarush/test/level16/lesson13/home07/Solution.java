    ...
    public static class Gamer extends Thread {
        ...
        public void run() {
            ...
            while (i!=OnlineGame.steps.size()){
                System.out.println(getName()+":"+String.valueOf(OnlineGame.steps.get(i++)));
                try{Thread.sleep(1000/rating);}catch (InterruptedException e){}
                if (i == OnlineGame.steps.size()){
                    OnlineGame.isWinnerFound = true;
                    System.out.println(getName()+":победитель!");
                    b=true;
                }
                if ((OnlineGame.isWinnerFound)&&(!b)){
